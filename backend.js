...
class registerBackend {
  ...
  constructor(srcFolderName, srcFolderID,
			  txtFileFolderName, txtFileFolderID,
			  csvFileFolderName, csvFileFolderID
			) 
 {
...
//function listTextFilesInFolder(folderID) {
	
	
//	console.log("begin");
	
	
//	console.log(DriveApp.getFolderById(folderID));
